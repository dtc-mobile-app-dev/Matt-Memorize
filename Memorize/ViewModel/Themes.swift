...
struct Themes {
    ...
    static let themes: [Theme<String>] =
        [
            ...
            Theme.init(content: ["⚽️", "🏈", "🎾", "⚾️", "🏐", "🏓", "🥍", "🥏", "🏀", "🏏", "🏒", "🤺"], color: RGBAColor(red: 0.0, green: 0.0, blue: 1.0,alpha: 1.0), themeName: "Sports", pairsOfCards: 12, id: 2),
            ...
            Theme.init(content: ["💽", "💾", "📞", "☎️", "📽", "📹", "📼", "📠", "📟", "🕹", "🖲", "💿"], color: RGBAColor(red: 1.0, green: 0.0, blue: 1.0,alpha: 1.0), themeName: "Tech", pairsOfCards: 12, id: 5)
        ]
}
